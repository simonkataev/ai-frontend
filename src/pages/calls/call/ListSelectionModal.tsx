...
function ListSelectionModal(props: any) {
  ...
  let teamsOptions = store.teams.map((team: any) => ({
    value: team.id,
    label: team.name,
  }));
  let spaceOptions = store.spaces.map((value: any) => ({
    value: value.id,
    label: value.name,
  }));
  let foldersOptions = store.folders.map((value: any) => ({
    value: value.id,
    label: value.name,
  }));
  let listOptions = store.lists.map((value: any) => ({
    value: value.id,
    label: value.name,
  }));
  let tasksOptions = store.tasks.map((value: any) => ({
    value: value.id,
    label: value.name,
  }));
